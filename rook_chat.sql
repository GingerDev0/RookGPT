...
CREATE TABLE IF NOT EXISTS `teams` (
  ...
  `bot_name` VARCHAR(80) NOT NULL DEFAULT 'AI',
  `bot_mention` VARCHAR(40) NOT NULL DEFAULT '@AI',
  `bot_custom_prompt` MEDIUMTEXT NULL,
  `bot_response_style` VARCHAR(40) NOT NULL DEFAULT 'concise',
  `bot_temperature` DECIMAL(3,2) NOT NULL DEFAULT 1.00,
  `bot_top_p` DECIMAL(3,2) NOT NULL DEFAULT 0.95,
  `bot_top_k` INT UNSIGNED NOT NULL DEFAULT 64,
  `bot_context_messages` INT UNSIGNED NOT NULL DEFAULT 100,
  `bot_max_reply_chars` INT UNSIGNED NOT NULL DEFAULT 5000,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `team_members` (
  ...
  `can_interact_with_bot` TINYINT(1) NOT NULL DEFAULT 1,
