...
if ($user && is_post()) {
    try {
        ...
        if (isset($_POST['disable_2fa'])) {
            ...
            } elseif (fetch_owned_team((int) $user['id']) || fetch_user_team_membership((int) $user['id'])) {
